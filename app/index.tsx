    ...
    >
      ...
      >
        ...
        <Text className="text-xl text-gray-800 dark:text-gray-200 mb-4">
          ...
          for me to record what I&apos;m learning and to share honest notes
          about projects, mistakes, and experiments.
        </Text>
        ...
        <Text className="text-xl text-gray-800 dark:text-gray-200 mb-4">
          I blog because writing helps me think clearly. This isn&apos;t
          marketing copy — it&apos;s a small, personal log of things I tried,
          what worked, what didn&apos;t, and the ideas I&apos;m exploring next.
          If something here helps you, that&apos;s great; if it doesn&apos;t,
          that&apos;s fine too — I write primarily for my own learning.
        </Text>
