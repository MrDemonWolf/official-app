...
| `EXPO_PUBLIC_MRDW_API_URL` | TailSignal push notification API base URL (e.g. `https://example.com/wp-json/mrdw/v1`) |
| `EXPO_PUBLIC_MRDW_API_URL` | PackRelay/WPForms contact form API base URL (e.g. `https://example.com/wp-json/mrdw/v1`) |
